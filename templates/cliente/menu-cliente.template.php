		...
		<div class="main-header">
			...
			<div class="main-panel">
				<div class="content">
					...
					<img src="<?php echo $absolute_include ?>templates/cliente/imgcliente/usuario.jpg" alt="" class="w-100" >
					<br>
					<br>
					<br>
					...
					<h5 class="titulo">sistema de turnos online</h5>
					<img style="display:block;margin-left: auto;margin-right: auto;" src="<?php echo $absolute_include ?>templates/cliente/imgcliente/turnosj.jpg" alt="" width="400" height="200"><br>
					</div>
					<div class="col-6 ">
					<h5 class="titulo">Te atendemos con gusto </h5>
			        <img style="display:block;margin-left: auto;margin-right: auto;" src="<?php echo $absolute_include ?>templates/cliente/imgcliente/atencion.jpg" alt="" width="400" height="200"><br>
					
					</div>
					<div class="col-6 mt-5">
					
					<img style="display:block;margin-left: auto;margin-right: auto;" src="<?php echo $absolute_include ?>templates/cliente/imgcliente/telfon.png" alt="" width="400" height="200"><br>
					<h5 class="titulo">Pide tu turno desde cualquier lugar</h5>
					</div>
